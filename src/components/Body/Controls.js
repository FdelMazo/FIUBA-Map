    ...
    >
      <Tooltip placement="top" label={`${useColorModeValue("Dark", "Light")} theme`}>
        <Link onClick={toggleColorMode}>
          {useColorModeValue(<MoonIcon boxSize={{ base: 4, md: 5 }} />, <SunIcon boxSize={{ base: 4, md: 5 }} />)}
        </Link>
      </Tooltip>
      <Tooltip placement="top" label="FIUBA-Plan">
        ...
        >
          <Icon boxSize={{ base: 4, md: 5 }} ml={{ base: 1, md: 2 }} viewBox="0 0 448 512">
            <path
              fill="currentColor"
      ...
      <Tooltip placement="top" label="FdelMazo/FIUBA-Map">
        ...
        >
          <Icon boxSize={{ base: 4, md: 5 }} ml={{ base: 1, md: 2 }} viewBox="0 0 16 16">
            <path
              fill="currentColor"
      ...
      <Tooltip placement="top" label="Invitame un Cafecito">
        ...
        >
          <Icon boxSize={{ base: 4, md: 5 }} ml={{ base: 1, md: 2 }} viewBox="0 0 512 512">
            <path
              fill="currentColor"
